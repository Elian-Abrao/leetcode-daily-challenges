...
- [#290 Pattern](https://leetcode.com/problems/word-pattern/)
  ...
  - Resolvido em: 13:30 - 23/02/26

- [#485 Ones](https://leetcode.com/problems/max-consecutive-ones/)
  - Question ID: 485
  - Arquivo: `problems/easy/485_max-consecutive-ones.py`
  - Resolvido em: 12:00 - 22/02/26

- [#326 Three](https://leetcode.com/problems/power-of-three/)
  - Question ID: 326
  - Arquivo: `problems/easy/326_power-of-three.py`
  - Resolvido em: 15:11 - 21/02/26

- [#202 Number](https://leetcode.com/problems/happy-number/)
  - Question ID: 202
...
- [#97 Interleaving String](https://leetcode.com/problems/interleaving-string/)
  - Question ID: 97
  - Arquivo: `problems/medium/97_interleaving-string.py`
  - Resolvido em: 19:15 - 22/07/26
...
- [#462 Minimum Moves to Equal Array Elements II](https://leetcode.com/problems/minimum-moves-to-equal-array-elements-ii/)
  ...
  - Resolvido em: 17:26 - 23/02/26

- [#12 Roman](https://leetcode.com/problems/integer-to-roman/)
  - Question ID: 12
  - Arquivo: `problems/medium/12_integer-to-roman.py`
  - Resolvido em: 21:00 - 22/02/26

- [#399 Division](https://leetcode.com/problems/evaluate-division/)
  - Question ID: 399
  - Arquivo: `problems/medium/399_evaluate-division.py`
  - Resolvido em: 16:00 - 22/02/26

- [#380 O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/)
  - Question ID: 380
  - Arquivo: `problems/medium/380_insert-delete-getrandom-o1.py`
  - Resolvido em: 15:09 - 21/02/26

- [#117 II](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii/)
  - Question ID: 117
  - Arquivo: `problems/medium/117_populating-next-right-pointers-in-each-node-ii.py`
  - Resolvido em: 15:08 - 21/02/26

- [#57 Interval](https://leetcode.com/problems/insert-interval/)
  - Question ID: 57
  - Arquivo: `problems/medium/57_insert-interval.py`
  - Resolvido em: 15:06 - 21/02/26

- [#17 Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)
  - Question ID: 17
  - Arquivo: `problems/medium/17_letter-combinations-of-a-phone-number.py`
  - Resolvido em: 15:04 - 21/02/26

- [#400 Digit](https://leetcode.com/problems/nth-digit/)
  - Question ID: 400
  - Arquivo: `problems/medium/400_nth-digit.py`
  - Resolvido em: 15:03 - 21/02/26

- [#347 Elements](https://leetcode.com/problems/top-k-frequent-elements/)
  - Question ID: 347
...
- [#1188 Brace Expansion II](https://leetcode.com/problems/brace-expansion-ii/)
  - Question ID: 1188
  - Arquivo: `problems/hard/1096_brace-expansion-ii.py`
  - Resolvido em: 18:00 - 23/08/26
...
- [#809 Function](https://leetcode.com/problems/preimage-size-of-factorial-zeroes-function/)
  - Question ID: 809
  - Arquivo: `problems/hard/793_preimage-size-of-factorial-zeroes-function.py`
  - Resolvido em: 13:41 - 23/02/26

- [#960 Spread](https://leetcode.com/problems/minimize-malware-spread/)
  - Question ID: 960
  - Arquivo: `problems/hard/924_minimize-malware-spread.py`
  - Resolvido em: 19:31 - 22/02/26

- [#1513 Strings](https://leetcode.com/problems/find-all-good-strings/)
  - Question ID: 1513
  - Arquivo: `problems/hard/1397_find-all-good-strings.py`
  - Resolvido em: 18:01 - 22/02/26

- [#41 Positive](https://leetcode.com/problems/first-missing-positive/)
  - Question ID: 41
  - Arquivo: `problems/hard/41_first-missing-positive.py`
  - Resolvido em: 13:30 - 22/02/26

- [#239 Maximum](https://leetcode.com/problems/sliding-window-maximum/)
  - Question ID: 239
  - Arquivo: `problems/hard/239_sliding-window-maximum.py`
  - Resolvido em: 22:30 - 21/02/26

- [#1466 V](https://leetcode.com/problems/jump-game-v/)
  - Question ID: 1466
  - Arquivo: `problems/hard/1340_jump-game-v.py`
  - Resolvido em: 19:30 - 21/02/26

- [#877 Nodes](https://leetcode.com/problems/shortest-path-visiting-all-nodes/)
  - Question ID: 877
  - Arquivo: `problems/hard/847_shortest-path-visiting-all-nodes.py`
  - Resolvido em: 17:30 - 21/02/26

- [#140 II](https://leetcode.com/problems/word-break-ii/)
  - Question ID: 140
  - Arquivo: `problems/hard/140_word-break-ii.py`
  - Resolvido em: 15:12 - 21/02/26

- [#381 allowed](https://leetcode.com/problems/insert-delete-getrandom-o1-duplicates-allowed/)
  - Question ID: 381
  - Arquivo: `problems/hard/381_insert-delete-getrandom-o1-duplicates-allowed.py`
  - Resolvido em: 15:07 - 21/02/26

- [#2319 Character](https://leetcode.com/problems/longest-substring-of-one-repeating-character/)
  - Question ID: 2319
  - Arquivo: `problems/hard/2213_longest-substring-of-one-repeating-character.py`
  - Resolvido em: 15:02 - 21/02/26

- [#1887 Graph](https://leetcode.com/problems/minimum-degree-of-a-connected-trio-in-a-graph/)
  - Question ID: 1887
  - Arquivo: `problems/hard/1761_minimum-degree-of-a-connected-trio-in-a-graph.py`
  - Resolvido em: 15:01 - 21/02/26

- [#854 Island](https://leetcode.com/problems/making-a-large-island/)
  - Question ID: 854
  - Arquivo: `problems/hard/827_making-a-large-island.py`
  - Resolvido em: 01:24 - 21/02/26

- [#472 Words](https://leetcode.com/problems/concatenated-words/)
  - Question ID: 472
  - Arquivo: `problems/hard/472_concatenated-words.py`
  - Resolvido em: 01:18 - 21/02/26

- [#1361 Squares](https://leetcode.com/problems/tiling-a-rectangle-with-the-fewest-squares/)
  - Question ID: 1361
  - Arquivo: `problems/hard/1240_tiling-a-rectangle-with-the-fewest-squares.py`
  - Resolvido em: 01:17 - 21/02/26
